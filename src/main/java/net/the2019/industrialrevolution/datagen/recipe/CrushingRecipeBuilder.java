...
public class CrushingRecipeBuilder implements CraftingRecipeJsonBuilder {
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.create();

    public CrushingRecipeBuilder(ItemConvertible ingredient, ItemConvertible result, int count) {
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(IndustrialRevolution.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_crushing");
        }

        @Override
        public RecipeSerializer<?> getSerializer() {
            return CrushingRecipe.Serializer.INSTANCE;
        }
